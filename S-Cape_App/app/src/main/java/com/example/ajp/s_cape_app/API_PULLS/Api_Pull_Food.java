...
import com.example.ajp.s_cape_app.Activities.Activity_Food;
...
public class Api_Pull_Food extends AsyncTask<String, Void, ArrayList<Object_Api_Pull>> {

    public ArrayList<Object_Api_Pull> apiArray;
    private Activity_Food foodActivity;
    ...
    public Api_Pull_Food(Activity_Food originalFoodScreen) {
        this.foodActivity = originalFoodScreen;
    }
            ...
            try {
                ...
                for (int i = 0; i < childrenData.length(); i++) {
                    ...
                    for (int j = 0; j < items.length(); j++) {
                        ...
                        Object_Api_Pull object = new Object_Api_Pull(name,address,message,"Food",lat,lon, shortName);
