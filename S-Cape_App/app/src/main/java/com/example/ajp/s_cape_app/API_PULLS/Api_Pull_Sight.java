...
import com.example.ajp.s_cape_app.Activities.Activity_Sights;
...
public class Api_Pull_Sight extends AsyncTask<String, Void, ArrayList<Object_Api_Pull>> {
    ...
    String lon;
        ...
        private Activity_Sights sightsActivity;

        public Api_Pull_Sight(Activity_Sights originalSightsScreen) {
            this.sightsActivity = originalSightsScreen;
        }
                ...
                try {
                    ...
                    for (int i = 0; i < childrenData.length(); i++) {
                        ...
                        for (int j = 0; j < items.length(); j++) {
                            ...
                            Object_Api_Pull object = new Object_Api_Pull(name,address,message,"Sights",lat,lon,shortName);
        ...
        protected void onPostExecute(ArrayList<Object_Api_Pull> strings) {
            ...
            sightsActivity.update(apiArray);
        }
    }
