...
import com.example.ajp.s_cape_app.Activities.Activity_Hotel;
...
public class Api_Pull_Hotel  extends AsyncTask<String, Void, ArrayList<Object_Api_Pull>> {
    ...
    private Activity_Hotel HotelActivity;

    public Api_Pull_Hotel(Activity_Hotel originalHotelScreen) {
        this.HotelActivity = originalHotelScreen;
    }
            ...
            try {
                ...
                for (int i = 0; i < childrenData.length(); i++) {
                    ...
                    for (int j = 0; j < items.length(); j++) {
                        ...
                        if(childrenDataObject.has("price")) {

                            JSONObject pricingObject = childrenDataObject.getJSONObject("price");

                            message = pricingObject.getString("message");
                        }else{
                            message = "varies";
                        }
                        ...
                        Object_Api_Pull object = new Object_Api_Pull(name,address,message,shortName,lat,lon, shortName);
